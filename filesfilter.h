...
public:
     ...
     * В итоге формируется список файлов, прошедших все фильтры, который можно получить при помощи метода fileList() или вывести в поток при помощи printFileList().
     ...
     * В итоге формируется список групп файлов-дубликатов, который можно получить при помощи метода sameFilesGroups() или вывести в поток при помощи printSameFiles().
